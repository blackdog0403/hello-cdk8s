...
export interface JenkinsSpecMaster {
   ...
   *
   * @default name: kubernetes version: 1.15.7 - name: workflow-job version: "2.39" - name: workflow-aggregator version: "2.6" - name: git version: 3.10.0 - name: job-dsl version: "1.74" - name: configuration-as-code version: "1.19" - name: kubernetes-credentials-provider version: 0.12.1
